...
public class WeatherSearchLogicTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testWarmingUp() {
        Person result = target.createPersonInfo();

        assertThat(result.getMyName(), is(""));
        assertThat(result.getAge(), is(""));
        assertThat(result.getHobby(), is(""));
        assertThat(result.getSkill(), is(""));
    }
}
